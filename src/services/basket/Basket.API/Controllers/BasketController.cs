...
namespace Basket.API.Controllers
{
    ...
    public class BasketController : ControllerBase
    {
        ...
        {
            // Communicate with Discount gRPC service to calculate discounted prices - if applicable - for each cart item
            // This kind of inter-service communication is performance critical, hence using the gRPC model.
